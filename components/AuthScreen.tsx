...
export default function AuthScreen() {
  ...
  const handleAuth = () => {
    ...
    // Dummy authentication - just show success and navigate to main app
    Alert.alert(
      'Success', 
      isLogin ? 'Welcome back to CropGuard!' : 'Welcome to CropGuard! Your account has been created successfully.',
      [
        {
          text: 'Continue',
